...
@NamedQueries({
    ...
    @NamedQuery(name = "TblOrdencompra.findByDemanda", query = "SELECT t FROM TblOrdencompra t WHERE t.demanda = :demanda"),
    @NamedQuery(name = "TblOrdencompra.findByClase", query = "SELECT t FROM TblOrdencompra t WHERE t.clase = :clase"),
    @NamedQuery(name = "TblOrdencompra.findByReceta", query = "SELECT t FROM TblOrdencompra t WHERE t.receta = :receta")})
public class TblOrdencompra implements Serializable {
    ...
    public String toString() {
        return "com.mim.clientes.models.TblOrdencompra[ tblOrdencompraPK=" + tblOrdencompraPK + " ]";
    }
