...
public class TblOrdencompraPK implements Serializable {
    ...
    public String toString() {
        return "com.mim.clientes.models.TblOrdencompraPK[ idtblordenCompra=" + idtblordenCompra + ", tblMaterialidTblMateria=" + tblMaterialidTblMateria + ", tblOrdenclienteidTblOrdencliente=" + tblOrdenclienteidTblOrdencliente + " ]";
    }
