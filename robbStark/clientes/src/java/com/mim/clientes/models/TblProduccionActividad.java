...
@NamedQueries({
    ...
    @NamedQuery(name = "TblProduccionActividad.findByEstatus", query = "SELECT t FROM TblProduccionActividad t WHERE t.estatus = :estatus"),
    @NamedQuery(name = "TblProduccionActividad.findByCantidadReal", query = "SELECT t FROM TblProduccionActividad t WHERE t.cantidadReal = :cantidadReal")})
public class TblProduccionActividad implements Serializable {
    ...
    public String toString() {
        return "com.mim.clientes.models.TblProduccionActividad[ idtblProduccionActividad=" + idtblProduccionActividad + " ]";
    }
